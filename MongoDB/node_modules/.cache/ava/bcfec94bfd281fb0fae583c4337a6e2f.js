...
(0, _ava2.default)('Add a person to the movie', async t => {
    ...
    const addPerson = await (0, _supertest2.default)(_app2.default).post('/movie/add-person').send(`${(createTitans.body._id, createJohn.body._id)}`);

    t.is(addPerson.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/bcfec94bfd281fb0fae583c4337a6e2f.js.map