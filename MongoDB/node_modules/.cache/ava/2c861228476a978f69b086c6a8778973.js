...
(0, _ava2.default)('Fetch a movie', async t => {
    ...
    const createTitans = await (0, _supertest2.default)(_app2.default).post('/movie').send(movieTitans);
    const fetchTitans = await reqeust(_app2.default).post(`/movie/${createTitans.body._id}`);

    t.is(fetchTitans.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/2c861228476a978f69b086c6a8778973.js.map