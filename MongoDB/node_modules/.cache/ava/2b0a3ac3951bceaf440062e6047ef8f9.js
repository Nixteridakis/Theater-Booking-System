...
(0, _ava2.default)('See list of shop items', async t => {
    ...
    const creation = await (0, _supertest2.default)(_index2.default).post('/item').send(createChocolate);
    const res = await (0, _supertest2.default)(_index2.default).get('./shop');
...
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/2b0a3ac3951bceaf440062e6047ef8f9.js.map