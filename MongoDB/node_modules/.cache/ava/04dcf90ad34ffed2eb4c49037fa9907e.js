...
(0, _ava2.default)('Create new Item', async t => {
    ...
    t.is(res.status, 200);
    t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(res, 'arguments/0/object/object').body, 'arguments/0/object').name, 'arguments/0'), {
        content: 't.true(res.body.name, createChocolate.name)',
        filepath: 'test/shop.js',
        line: 28,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[7,10]},"property":{"type":"Identifier","name":"body","range":[11,15]},"computed":false,"range":[7,15]},"property":{"type":"Identifier","name":"name","range":[16,20]},"computed":false,"range":[7,20]},{"type":"MemberExpression","object":{"type":"Identifier","name":"createChocolate","range":[22,37]},"property":{"type":"Identifier","name":"name","range":[38,42]},"computed":false,"range":[22,42]}],"range":[0,43]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"res","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"body","range":[11,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"name","range":[16,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"name"},"value":"createChocolate","range":[22,37]},{"type":{"label":"."},"range":[37,38]},{"type":{"label":"name"},"value":"name","range":[38,42]},{"type":{"label":")"},"range":[42,43]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), createChocolate.name);
    t.true(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(res, 'arguments/0/object/object').body, 'arguments/0/object').price, 'arguments/0'), {
        content: 't.true(res.body.price, createChocolate.price)',
        filepath: 'test/shop.js',
        line: 29,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[7,10]},"property":{"type":"Identifier","name":"body","range":[11,15]},"computed":false,"range":[7,15]},"property":{"type":"Identifier","name":"price","range":[16,21]},"computed":false,"range":[7,21]},{"type":"MemberExpression","object":{"type":"Identifier","name":"createChocolate","range":[23,38]},"property":{"type":"Identifier","name":"price","range":[39,44]},"computed":false,"range":[23,44]}],"range":[0,45]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"res","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"body","range":[11,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"price","range":[16,21]},{"type":{"label":","},"range":[21,22]},{"type":{"label":"name"},"value":"createChocolate","range":[23,38]},{"type":{"label":"."},"range":[38,39]},{"type":{"label":"name"},"value":"price","range":[39,44]},{"type":{"label":")"},"range":[44,45]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), createChocolate.price);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/04dcf90ad34ffed2eb4c49037fa9907e.js.map