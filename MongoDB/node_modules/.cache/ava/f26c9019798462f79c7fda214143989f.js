...
(0, _ava2.default)('Fetch a person', async t => {
    ...
    const fetchPerson = await (0, _supertest2.default)(_app2.default).post(`/person/${creation.body._id}`);

    t.is(fetchPerson.status, 200);
    // t.is(fetchTitans.body.name, movieTitans.name)
    // t.is(fetchTitans.body.price, movieTitans.price)
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/f26c9019798462f79c7fda214143989f.js.map