...
(0, _ava2.default)('Fetch a movie', async t => {
    ...
    const createTitans = await (0, _supertest2.default)(_app2.default).post('/movie').send(movieTitans);
    const fetchTitans = await (0, _supertest2.default)(_app2.default).post(`/movie/${createTitans.body._id}/json`);

    t.is(fetchTitans.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/51c29be3cf221c59145d0b40c9d9b703.js.map