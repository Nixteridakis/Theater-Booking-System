...
(0, _ava2.default)('Create new Item', async t => {
    ...
    t.is(res.status, 200);
    t.true(_rec3._expr(_rec3._capt(_rec3._capt(Array, 'arguments/0/callee/object').isArray(_rec3._capt(_rec3._capt(res, 'arguments/0/arguments/0/object').body, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(Array.isArray(res.body), \'Body is array\')',
        filepath: 'test/shop.js',
        line: 28,
        async: true,
    ...
    t.true(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(_rec4._capt(res, 'arguments/0/left/object/object').body, 'arguments/0/left/object').length, 'arguments/0/left') > 0, 'arguments/0'), {
        content: 't.true(res.body.length > 0)',
        filepath: 'test/shop.js',
        line: 29,
        async: true,
...
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/b8a4be33f6cc356e3e13909fb48f6f1d.js.map