...
(0, _ava2.default)('Add a person to the movie', async t => {
    ...
    const addPerson = await (0, _supertest2.default)(_app2.default).post(`/movie/${createTitans.body._id}/addPerson`).send({ personId: createJohn.body._id });
...
(0, _ava2.default)('See list of persons', async t => {
    ...
    const creation = await (0, _supertest2.default)(_app2.default).post('/person').send(newPerson);

    const people = await (0, _supertest2.default)(_app2.default).get('/people');

    t.is(people.status, 200);
    t.true(_rec5._expr(_rec5._capt(_rec5._capt(Array, 'arguments/0/callee/object').isArray(_rec5._capt(_rec5._capt(people, 'arguments/0/arguments/0/object').body, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(Array.isArray(people.body))',
        filepath: 'test/shop-services.js',
        line: 172,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Array","range":[7,12]},"property":{"type":"Identifier","name":"isArray","range":[13,20]},"computed":false,"range":[7,20]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"people","range":[21,27]},"property":{"type":"Identifier","name":"body","range":[28,32]},"computed":false,"range":[21,32]}],"range":[7,33]}],"range":[0,34]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Array","range":[7,12]},{"type":{"label":"."},"range":[12,13]},{"type":{"label":"name"},"value":"isArray","range":[13,20]},{"type":{"label":"("},"range":[20,21]},{"type":{"label":"name"},"value":"people","range":[21,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"body","range":[28,32]},{"type":{"label":")"},"range":[32,33]},{"type":{"label":")"},"range":[33,34]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
    t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(_rec6._capt(people, 'arguments/0/left/object/object').body, 'arguments/0/left/object').length, 'arguments/0/left') > 0, 'arguments/0'), {
        content: 't.true(people.body.length > 0)',
        filepath: 'test/shop-services.js',
        line: 173,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":">","left":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"people","range":[7,13]},"property":{"type":"Identifier","name":"body","range":[14,18]},"computed":false,"range":[7,18]},"property":{"type":"Identifier","name":"length","range":[19,25]},"computed":false,"range":[7,25]},"right":{"type":"NumericLiteral","value":0,"range":[28,29]},"range":[7,29]}],"range":[0,30]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"people","range":[7,13]},{"type":{"label":"."},"range":[13,14]},{"type":{"label":"name"},"value":"body","range":[14,18]},{"type":{"label":"."},"range":[18,19]},{"type":{"label":"name"},"value":"length","range":[19,25]},{"type":{"label":"</>"},"value":">","range":[26,27]},{"type":{"label":"num"},"value":0,"range":[28,29]},{"type":{"label":")"},"range":[29,30]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});

(0, _ava2.default)('Create a person', async t => {
    const newPerson = {
        name: 'Cola',
        age: 33,
        shopped: []
...
(0, _ava2.default)('Fetch a person', async t => {
    const newPerson = {
        name: 'Cola',
        age: 33,
        shopped: []
    ...
    const fetchPerson = await (0, _supertest2.default)(_app2.default).get(`/person/${creation.body._id}`);

    t.is(fetchPerson.status, 200);
    t.deepEqual(creation.body, fetchPerson.body);
});

(0, _ava2.default)('Delete a person', async t => {
    const newPerson = {
        name: 'Cola',
        age: 33,
        shopped: []
    ...
    const deletePerson = await (0, _supertest2.default)(_app2.default).delete(`/person/${creation.body._id}`);

    t.is(deletePerson.status, 200);

    const fetchPerson = await (0, _supertest2.default)(_app2.default).get(`/person/${creation.body._id}/json`);

    t.is(fetchPerson.status, 404);
});

(0, _ava2.default)('Add item to the person', async t => {
    const newPerson = {
        name: 'Kostas',
        age: 33,
        shopped: []
    ...
    const createPerson = await (0, _supertest2.default)(_app2.default).post('/person').send(newPerson);

    const createItem = await (0, _supertest2.default)(_app2.default).post('/item').send(newItem);

    const addItem = await (0, _supertest2.default)(_app2.default).post(`/person/${createPerson.body._id}/add-item`).send({ itemId: createItem.body._id });
...
//Theater Services
(0, _ava2.default)('See list of theaters', async t => {
    ...
    const creation = await (0, _supertest2.default)(_app2.default).post('/theater').send(newTheater);

    const theatersList = await (0, _supertest2.default)(_app2.default).get('/theaters');

    t.is(theatersList.status, 200);
    t.true(_rec7._expr(_rec7._capt(_rec7._capt(Array, 'arguments/0/callee/object').isArray(_rec7._capt(_rec7._capt(theatersList, 'arguments/0/arguments/0/object').body, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(Array.isArray(theatersList.body))',
        filepath: 'test/shop-services.js',
        line: 277,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Array","range":[7,12]},"property":{"type":"Identifier","name":"isArray","range":[13,20]},"computed":false,"range":[7,20]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"theatersList","range":[21,33]},"property":{"type":"Identifier","name":"body","range":[34,38]},"computed":false,"range":[21,38]}],"range":[7,39]}],"range":[0,40]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Array","range":[7,12]},{"type":{"label":"."},"range":[12,13]},{"type":{"label":"name"},"value":"isArray","range":[13,20]},{"type":{"label":"("},"range":[20,21]},{"type":{"label":"name"},"value":"theatersList","range":[21,33]},{"type":{"label":"."},"range":[33,34]},{"type":{"label":"name"},"value":"body","range":[34,38]},{"type":{"label":")"},"range":[38,39]},{"type":{"label":")"},"range":[39,40]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
    t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(_rec8._capt(theatersList, 'arguments/0/left/object/object').body, 'arguments/0/left/object').length, 'arguments/0/left') > 0, 'arguments/0'), {
        content: 't.true(theatersList.body.length > 0)',
        filepath: 'test/shop-services.js',
        line: 278,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":">","left":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"theatersList","range":[7,19]},"property":{"type":"Identifier","name":"body","range":[20,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"length","range":[25,31]},"computed":false,"range":[7,31]},"right":{"type":"NumericLiteral","value":0,"range":[34,35]},"range":[7,35]}],"range":[0,36]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"theatersList","range":[7,19]},{"type":{"label":"."},"range":[19,20]},{"type":{"label":"name"},"value":"body","range":[20,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"length","range":[25,31]},{"type":{"label":"</>"},"value":">","range":[32,33]},{"type":{"label":"num"},"value":0,"range":[34,35]},{"type":{"label":")"},"range":[35,36]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});

(0, _ava2.default)('Create a theater', async t => {
    const newTheater = {
        name: 'Max',
        totalSales: 130,
        movies: []
...
(0, _ava2.default)('Fetch a theater', async t => {
    const newTheater = {
        name: 'Max',
        totalSales: 130,
        movies: []
    ...
    const fetchTheater = await (0, _supertest2.default)(_app2.default).get(`/theater/${creation.body._id}`);

    t.is(fetchTheater.status, 200);
    t.deepEqual(creation.body, fetchTheater.body);
});

(0, _ava2.default)('Delete a theater', async t => {
    const newTheater = {
        name: 'Max',
        totalSales: 130,
        movies: []
    ...
    const deleteTheater = await (0, _supertest2.default)(_app2.default).delete(`/theater/${creation.body._id}`);

    const fetchTheater = await (0, _supertest2.default)(_app2.default).get(`/theater/${creation.body._id}/json`);

    t.is(deleteTheater.status, 200);
    t.is(fetchTheater.status, 404);
});

(0, _ava2.default)('Add a movie to a theater', async t => {
    const newTheater = {
        name: 'Max',
        totalSales: 130,
        movies: []
    ...
    const createMovie = await (0, _supertest2.default)(_app2.default).post('/movie').send(newTitans);

    const createTheater = await (0, _supertest2.default)(_app2.default).post('/theater').send(newTheater);

    const addMovie = await (0, _supertest2.default)(_app2.default).post(`/theater/${createTheater.body._id}/add-movie`).send({ movieId: createMovie.body._id });

    t.is(addMovie.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/424f77cdfee1a2918f6519f3d03afcb1.js.map