...
(0, _ava2.default)('Add a person to the movie', async t => {
    ...
    const addPerson = await (0, _supertest2.default)(_app2.default).post('/movie/add-person').send(`${(createTitans.body._id, createJohn.body._id)}/json`);

    t.is(createTitans.status, 200);
    t.is(createJohn.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/5b9e81dad4c6bbe2d37fce4175ef1651.js.map