...
(0, _ava2.default)('Add a movie', async t => {
    ...
    t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(createTitans, 'arguments/0/object/object').body, 'arguments/0/object').name, 'arguments/0'), {
        content: 't.true(createTitans.body.name, movieTitans.name)',
        filepath: 'test/shop-services.js',
        line: 98,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"createTitans","range":[7,19]},"property":{"type":"Identifier","name":"body","range":[20,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"name","range":[25,29]},"computed":false,"range":[7,29]},{"type":"MemberExpression","object":{"type":"Identifier","name":"movieTitans","range":[31,42]},"property":{"type":"Identifier","name":"name","range":[43,47]},"computed":false,"range":[31,47]}],"range":[0,48]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"createTitans","range":[7,19]},{"type":{"label":"."},"range":[19,20]},{"type":{"label":"name"},"value":"body","range":[20,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"name","range":[25,29]},{"type":{"label":","},"range":[29,30]},{"type":{"label":"name"},"value":"movieTitans","range":[31,42]},{"type":{"label":"."},"range":[42,43]},{"type":{"label":"name"},"value":"name","range":[43,47]},{"type":{"label":")"},"range":[47,48]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), movieTitans.name);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/928c0d9941698b0846cee54881373968.js.map