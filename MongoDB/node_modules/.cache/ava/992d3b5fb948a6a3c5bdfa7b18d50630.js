...
(0, _ava2.default)('Fetch a person', async t => {
    ...
    const fetchPerson = await (0, _supertest2.default)(_app2.default).post(`/person/${creation.body._id}/json`);

    t.is(fetchPerson.status, 200);
    // t.is(fetchTitans.body.name, movieTitans.name)
    // t.is(fetchTitans.body.price, movieTitans.price)
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/992d3b5fb948a6a3c5bdfa7b18d50630.js.map