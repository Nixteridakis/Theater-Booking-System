...
(0, _ava2.default)('Delete an Item', async t => {
    ...
    const deleteChocolate = await (0, _supertest2.default)(_app2.default).delete(`/item/${createdChocolate._id}`);

    t.is(deleteChocolate.status, 200);
    t.is(deleteChocolate, 'ok!');
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/2e554b23a0848abcb949e5eb6e6a7caf.js.map