...
(0, _ava2.default)('Create new Item', async t => {
    ...
    t.is(res.status, 200);
    t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(_rec3._capt(res, 'arguments/0/object/object/object').status, 'arguments/0/object/object').body, 'arguments/0/object').name, 'arguments/0'), {
        content: 't.true(res.status.body.name, createChocolate.name)',
        filepath: 'test/shop.js',
        line: 28,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[7,10]},"property":{"type":"Identifier","name":"status","range":[11,17]},"computed":false,"range":[7,17]},"property":{"type":"Identifier","name":"body","range":[18,22]},"computed":false,"range":[7,22]},"property":{"type":"Identifier","name":"name","range":[23,27]},"computed":false,"range":[7,27]},{"type":"MemberExpression","object":{"type":"Identifier","name":"createChocolate","range":[29,44]},"property":{"type":"Identifier","name":"name","range":[45,49]},"computed":false,"range":[29,49]}],"range":[0,50]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"res","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"status","range":[11,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"body","range":[18,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"name","range":[23,27]},{"type":{"label":","},"range":[27,28]},{"type":{"label":"name"},"value":"createChocolate","range":[29,44]},{"type":{"label":"."},"range":[44,45]},{"type":{"label":"name"},"value":"name","range":[45,49]},{"type":{"label":")"},"range":[49,50]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), createChocolate.name);
    t.true(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(_rec4._capt(res, 'arguments/0/object/object/object').status, 'arguments/0/object/object').body, 'arguments/0/object').price, 'arguments/0'), {
        content: 't.true(res.status.body.price, createChocolate.price)',
        filepath: 'test/shop.js',
        line: 29,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[7,10]},"property":{"type":"Identifier","name":"status","range":[11,17]},"computed":false,"range":[7,17]},"property":{"type":"Identifier","name":"body","range":[18,22]},"computed":false,"range":[7,22]},"property":{"type":"Identifier","name":"price","range":[23,28]},"computed":false,"range":[7,28]},{"type":"MemberExpression","object":{"type":"Identifier","name":"createChocolate","range":[30,45]},"property":{"type":"Identifier","name":"price","range":[46,51]},"computed":false,"range":[30,51]}],"range":[0,52]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"res","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"status","range":[11,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"body","range":[18,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"price","range":[23,28]},{"type":{"label":","},"range":[28,29]},{"type":{"label":"name"},"value":"createChocolate","range":[30,45]},{"type":{"label":"."},"range":[45,46]},{"type":{"label":"name"},"value":"price","range":[46,51]},{"type":{"label":")"},"range":[51,52]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), createChocolate.price);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/c80fd2e518349e2349136fae85f01858.js.map