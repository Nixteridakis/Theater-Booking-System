...
(0, _ava2.default)('Add a person to the movie', async t => {
    ...
    const lemmesee = await (0, _supertest2.default)(_app2.default).get('/people');
    console.log(createTitans.body);
    const addPerson = await (0, _supertest2.default)(_app2.default).post(`/movie/${createTitans.body._id}/addPerson`).send({ personId: createJohn._id });

    t.is(addPerson.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/4409bf9652b1fd4e72bc8892e4870e98.js.map