...
(0, _ava2.default)('Add a person to the movie', async t => {
    ...
    // const addPerson = await request(app).post('/movie/add-person').send(`${createTitans.body._id, createJohn.body._id}`)

    t.is(createTitans.status, 200);
});
//# sourceMappingURL=/Users/marinoschrysanthou/Desktop/Web Design/WTB/Course 6/homework/node_modules/.cache/ava/2cf2c9f4dbeb1c6937df0f213a8c4c1f.js.map